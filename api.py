...
def populate_db():
    for product_data in json_data["products"]:
        ...
        product = Product.objects.create(
            ...
            discount_percentage=Decimal(product_data.get("discountPercentage", 0)),
            stock=product_data["stock"],
            weight=product_data["weight"],
            dimensions=product_data["dimensions"],
            brand=product_data["brand"],
            warranty=product_data["warrantyInformation"],
            shipping_info=product_data["shippingInformation"],
            return_policy=product_data["returnPolicy"]
        )
        ...
        #     user_email = review_data["reviewerEmail"]
        #     user, created = Custo.objects.get_or_create(
        #         email=user_email,
